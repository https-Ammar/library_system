...
<body x-data="{isTaskModalModal:false,darkMode:false,loaded:true,stickyMenu:false,sidebarToggle:false,scrollTop:false,editModalOpen:false,currentStudent:{}}"
                    ...
                    <div class="col-span-12">
                                        ...
                                        <tr>
                                            ...
                                            <td class="px-6 py-3 whitespace-nowrap">
                                                <p class="text-gray-700 text-theme-sm dark:text-gray-400">
                                                    <?=htmlspecialchars($student['address']??'-')?></p>
                                            </td>
                                            ...
                                            <td class="px-6 py-3 whitespace-nowrap">
                                                <p class="text-gray-700 text-theme-sm dark:text-gray-400">
                                                    <?=htmlspecialchars($student['grade_name']??'-')?></p>
                                            </td>

                                            <td class="px-6 py-3 whitespace-nowrap">
                                                <p class="text-gray-700 text-theme-sm dark:text-gray-400">
                                                    <?=date('Y-m-d',strtotime($student['created_at']))?></p>
                                            </td>

                                            <td class="px-6 py-3 whitespace-nowrap">
                                                <div class="flex items-center justify-center gap-3">
                                                    <button @click="editModalOpen=true;currentStudent={student_id:'<?=$student['student_id']?>',name:'<?=htmlspecialchars($student['name'], ENT_QUOTES)?>',address:'<?=htmlspecialchars($student['address'], ENT_QUOTES)?>',phone:'<?=htmlspecialchars($student['phone'], ENT_QUOTES)?>'}" class="cursor-pointer hover:fill-brand-500 dark:hover:fill-brand-500 fill-gray-700 dark:fill-gray-400">
                                                    ...
                                                    <a href="?delete=<?=$student['student_id']?>"
                                                        ...
                                                        class="cursor-pointer hover:fill-error-500 dark:hover:fill-error-500 fill-gray-700 dark:fill-gray-400"><svg
                                                            ...
                                                            viewBox="0 0 16 16">
                                                            <path
                                                                d="M4.54.146A.5.5 0 0 1 4.893 0h6.214a.5.5 0 0 1 .353.146l4.394 4.394a.5.5 0 0 1 .146.353v6.214a.5.5 0 0 1-.146.353l-4.394 4.394a.5.5 0 0 1-.353.146H4.893a.5.5 0 0 1-.353-.146L.146 11.46A.5.5 0 0 1 0 11.107V4.893a.5.5 0 0 1 .146-.353zM5.1 1 1 5.1v5.8L5.1 15h5.8l4.1-4.1V5.1L10.9 1z"></path>
                                                            <path
                                        ...
                                        <div class="grid grid-cols-1 gap-x-6 gap-y-5 sm:grid-cols-2">
                                            ...
                                            <div class="sm:col-span-2">
                                                ...
                                                <select name="grade_id"
                                                    ...
                                                    <?php $grades->data_seek(0); while($grade=$grades->fetch_assoc()): ?>
                        ...
                        <div x-show="editModalOpen" x-transition:enter="transition ease-out duration-300" x-transition:enter-start="opacity-0 scale-95" x-transition:enter-end="opacity-100 scale-100" x-transition:leave="transition ease-in duration-200" x-transition:leave-start="opacity-100 scale-100" x-transition:leave-end="opacity-0 scale-95" class="fixed inset-0 flex items-center justify-center p-5 overflow-y-auto z-99999" :class="{'hidden':!editModalOpen}" style="">
                            ...
                            <div @click.outside="editModalOpen=false" class="no-scrollbar relative w-full max-w-[700px] mx-auto overflow-y-auto rounded-3xl bg-white p-6 dark:bg-gray-900 lg:p-11">
                                <div class="px-2">
                                    <h4 class="mb-2 text-2xl font-semibold text-gray-800 dark:text-white/90">تعديل بيانات الطالب</h4>
                                    <p class="mb-6 text-sm text-gray-500 dark:text-gray-400 lg:mb-7">تعديل بيانات الطالب</p>
                                </div>
                                    ...
                                    <div class="custom-scrollbar overflow-y-auto px-2">
                                        <div class="grid grid-cols-1 gap-x-6 gap-y-5 sm:grid-cols-2">
                                            <div class="sm:col-span-2">
                                                ...
                                                <input type="text" name="name" x-model="currentStudent.name" required="" class="h-11 w-full rounded-lg border border-gray-300 bg-transparent px-4 py-2.5 text-sm text-gray-800 placeholder:text-gray-400 focus:border-brand-300 focus:ring-3 focus:ring-brand-500/10 dark:border-gray-700 dark:bg-gray-900 dark:text-white/90">
                                            </div>
                                            <div class="sm:col-span-2">
                                                <label class="mb-1.5 block text-sm font-medium text-gray-700 dark:text-gray-400">العنوان</label>
                                                <input type="text" name="address" x-model="currentStudent.address" class="h-11 w-full rounded-lg border border-gray-300 bg-transparent px-4 py-2.5 text-sm text-gray-800 placeholder:text-gray-400 focus:border-brand-300 focus:ring-3 focus:ring-brand-500/10 dark:border-gray-700 dark:bg-gray-900 dark:text-white/90">
                                            </div>
                                            <div class="sm:col-span-2">
                                                <label class="mb-1.5 block text-sm font-medium text-gray-700 dark:text-gray-400">الهاتف</label>
                                                <input type="text" name="phone" x-model="currentStudent.phone" class="h-11 w-full rounded-lg border border-gray-300 bg-transparent px-4 py-2.5 text-sm text-gray-800 placeholder:text-gray-400 focus:border-brand-300 focus:ring-3 focus:ring-brand-500/10 dark:border-gray-700 dark:bg-gray-900 dark:text-white/90">
                                            </div>
                                        </div>
                                    </div>
