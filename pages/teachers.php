            ...
            <div class="col-span-12">
                    ...
                    <div class="max-w-full overflow-x-auto custom-scrollbar">
                        <table class="min-w-full">
                            ...
                            <tbody class="divide-y divide-gray-100 dark:divide-gray-800">
                                    ...
                                    <?php while ($teacher = $result->fetch_assoc()): ?>
                                        <tr>
                                            ...
                                            <td class="px-6 py-3 whitespace-nowrap">
                                                ...
                                                $stmt_books->close();
                                                ?>
                                                <p class="text-gray-700 text-theme-sm dark:text-gray-400"><?= $books_count ?>
                                                    كتاب</p>
                                            </td>
                                            <td class="px-6 py-3 whitespace-nowrap">
                                ...
                                <?php else: ?>
                                    <tr>
                                        <td colspan="7" class="px-6 py-4 text-center text-gray-500 dark:text-gray-400">لا
                                            توجد بيانات</td>
                                    </tr>
                                <?php endif; ?>
                            </tbody>
                ...
                <div x-show="isTaskModalModal" x-transition
                    ...
                    <div @click.outside="isTaskModalModal = false"
                        ...
                        <div class="px-2">
                            <h4 class="mb-2 text-2xl font-semibold text-gray-800 dark:text-white/90">إضافة مدرس جديد
                            </h4>
                                ...
                                <div class="grid grid-cols-1 gap-x-6 gap-y-5 sm:grid-cols-2">
                                    ...
                                    <div class="sm:col-span-2">
                                        ...
                                        <?php if ($grades_result && $grades_result->num_rows > 0): ?>
                                            <?php while ($grade = $grades_result->fetch_assoc()): ?>
                                                ...
                                                <div class="flex items-center mb-2">
                                                    <input type="checkbox" id="<?= $checkbox_id ?>" name="grades[]"
                                                        value="<?= $grade['grade_id'] ?>" <?= in_array($grade['grade_id'], $selected_grades ?? []) ? 'checked' : '' ?>
                                            ...
                                            <?php endwhile; ?>
                                            <?php $grades_result->data_seek(0); // Reset pointer ?>
                                        <?php else: ?>
