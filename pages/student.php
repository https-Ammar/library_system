...
if ($search !== '') {
    $query .= " AND (s.name LIKE '%" . $mysqli->real_escape_string($search) . "%' 
              OR s.email LIKE '%" . $mysqli->real_escape_string($search) . "%'
              OR s.phone LIKE '%" . $mysqli->real_escape_string($search) . "%')";
}
                                            ...
                                            <td class="px-6 py-3 whitespace-nowrap">
                                                <div class="flex items-center justify-center gap-3">
                                                    ...
                                                    <a href="?delete=<?= $student['student_id'] ?>"
                                                        onclick="return confirm('هل تريد حذف هذا الطالب؟');"
                ...
                <div x-show="isTaskModalModal" x-transition
                    ...
                    <div @click.outside="isTaskModalModal = false"
                        ...
                        <div class="px-2">
                            ...
                            <h4 class="mb-2 text-2xl font-semibold text-gray-800 dark:text-white/90">إضافة طالب جديد
                            </h4>
